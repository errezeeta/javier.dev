...
export default function Home() {
  return (
    <main className="container flex flex-col items-center gap-10 print:gap-4 px-6 py-16 print:py-0 md:p-24 max-w-5xl overflow-x-hidden">
      <Intro />
      <Contact />
      <CoreSkills />
      <About />
      ...
      <footer className="text-center text-sm mb-3 print:hidden flex flex-col gap-3 items-center">
        <div className="flex items-center gap-1">
          Made with ❤️ using TypeScript, React, Next.js, Tailwind CSS and
          shadcn/ui
          <a href="https://github.com/errezeeta" target="_blank">
